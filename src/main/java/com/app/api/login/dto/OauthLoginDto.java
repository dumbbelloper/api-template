...
public class OauthLoginDto {
    ...
    public static class Response {
        ...
        @Schema(description = "refreshToken", example = "eyJ0eXBlIjoiSldUIiwiYWxnIjoiSFM1MTIifQ.eyJzdWIiOiJBQ0NFU1MiLCJpYXQiOjE2Nzg1MjY2NTIsImV4cCI6MTY3OTczNjI1MiwibWVtYmVySWQiOjF9.ssy9_htq1aN4ubqcuXsOxFJOKzyS1Mw64eRVNmMozk5JE-bOrdfaJ7KDWU-4m3HWSTyQ6r8NwHKwwxnwNECqSg", required = true)
        private String refreshToken;
        @Schema(description = "refresh token 만료 시간", example = "2022-08-12 18:13:16", required = true)
        @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd HH:mm:ss", timezone = "Asia/Seoul")
